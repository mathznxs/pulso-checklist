...
import { getShifts, getAllProfiles, getSetores } from "@/lib/actions/admin"
...
export default async function EscalaPage() {
  ...
  const [todaySchedule, weekSchedule, shifts, allSchedules, profiles, setores] = await Promise.all([
